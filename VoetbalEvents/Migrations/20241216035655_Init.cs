        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxKaarten = table.Column<int>(type: "int", nullable: false),
                    Toeschouwers = table.Column<int>(type: "int", nullable: false),
                    Foto = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wedstrijds", x => x.WedstrijdID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reserverings", x => x.ReserveringID);
                    table.ForeignKey(
                        name: "FK_reserverings_Wedstrijds_WedstrijdID",
                        column: x => x.WedstrijdID,
                        principalTable: "Wedstrijds",
            ...
            migrationBuilder.InsertData(
                table: "reserverings",
                columns: new[] { "ReserveringID", "Datum", "WedstrijdID" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reserverings_WedstrijdID",
                table: "reserverings",
                column: "WedstrijdID");
        }
